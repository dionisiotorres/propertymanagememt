...
class POSDailySale(models.Model):
    ...
    tenant_code = fields.Char("TenantCode")
    busines_date = fields.Date("BusinessDate")
    transaction_time = fields.Datetime("TransactionTime")
    transaction_count = fields.Integer("TransactionCount")
    currency = fields.Many2one("res.currency", "Currency")
    grosssalesamount = fields.Float("GrossSaleAmount")
    tax_amount = fields.Float("Tax")
    servicecharge = fields.Float("ServiceCharge")
    discount = fields.Float("Discount")
    adjustment = fields.Float("Adjustment")
    net_sale_amount = fields.Float("NetSaleAmount")
    pos_interface_code = fields.Char("POSInterfaceCode")
    pos_receipt_date = fields.Date("POSReceiptDate")
    daily_sale_amtaftertax = fields.Float("DailySaleAmtAfterTax")
    daily_sale_amt_b4tax = fields.Float("DailySaleAmtB4Tax")
    daily_servicechargeamt = fields.Float("DailyServiceChargeAmt")
    daily_item_count = fields.Integer("DailyItemCount")
    daily_receipt_count = fields.Integer("DailyReceiptCount")
    ntd_flag = fields.Boolean("NTDFlag")
    net_sales = fields.Float("NetSales")
